({
    displayFieldData : function(cmp) {
        ...
        console.log('-----selRecName------'+cmp.get("v.selRecName"));
        console.log('-----selRecId------'+cmp.get("v.selRecId"));
        console.log('-----getReference------'+cmp.getReference("v.selRecName"));
        
        if(cmp.getReference("v.selRecName")) {
    ...
    doSearch : function(cmp) {
        ...
        console.log('----inn search---'+cmp.get("v.searchString"));
        ...
        console.log('----sObjectAPIName-----'+sObjectAPIName);
        // Set the parameters
        action.setParams({ "searchString" : searchString, "sObjectAPIName" : sObjectAPIName, "isLOFilter" : cmp.get("v.isFilter")});
...
console.log('==>in here2',li);
 ...
 console.log('==>in here3',lookupListItemsBody);
    ...
    handleSelection : function(cmp, event) {
        ...
        listOfselectedUsers.push(newSelectedUserObject);
        cmp.set("v.lstSelectedUsers", listOfselectedUsers);
        console.log('listOfselectedUsers=======<>>>>', listOfselectedUsers);
        
        // Event to notify the parent component for the list of values selected.
        var updateLookupEvt = cmp.getEvent("updateLookupEvt");
        updateLookupEvt.setParams({
            "selectedId" : objectId,
            "selectedName" : objectLabel
        });
