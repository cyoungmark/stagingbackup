({
    ...
    handleEventInitHelper : function(component, event, helper){
        ...
        helper.utilQueryAreRequestsReady(component, helper);
    ...
    utilQueryAreRequestsReady : function(component, helper) {
        ...
        helper.utilCallServer(
            ...
            function(response) {
                ...
                component.set("v.isRequestsReady", response);

            },

            {

                "theFormId"  :   component.get("v.recordId")
